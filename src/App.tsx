...
// Pages — lazy loaded (admin/infrequent routes)
const Onboarding = React.lazy(() =>
  import('./pages/Onboarding').then((m) => ({ default: m.Onboarding }))
);
const Handoff = React.lazy(() => import('./pages/Handoff').then((m) => ({ default: m.Handoff })));
const Workload = React.lazy(() =>
  import('./pages/Workload').then((m) => ({ default: m.Workload }))
);
